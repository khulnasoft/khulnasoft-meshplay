...
import ImageAppIcon from "../../../../src/assets/images/learn-khulnasoft/istio/istio-addons.webp";
import GraffanaDash from "../../../../src/assets/images/learn-khulnasoft/istio/Grafana_Istio_Dashboard.webp";
import Prometheus from "../../../../src/assets/images/learn-khulnasoft/istio/Prometheus.webp";
import Jaeger from "../../../../src/assets/images/learn-khulnasoft/istio/jaeger copy.webp";

<ChapterStyle>

<h2 class="chapter-sub-heading">Install Telemetry Add-ons</h2>

Using Meshplay, install Istio telemetry add-ons. In the Istio management page:
...
Use the computed URL above in Meshplay, in the browser, to run a load test and see the results.

<h3 class="chapter-sub-heading">
  Connect Grafana (optionally, Prometheus) to Meshplay.
</h3>
...
<h3 class="chapter-sub-heading">
  Use Meshplay to generate load and analyze performance.
</h3>
