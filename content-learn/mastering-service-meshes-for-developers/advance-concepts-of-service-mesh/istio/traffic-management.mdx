...
```
_Using Meshplay, apply custom configuration._
...
spec:
  hosts:
    - "bookinfo.meshplay.khulnasoft.com"
  gateways:
    - sample-app-gateway
  http:
    - match:
...
Move to 50%. Observe in Meshplay.
...
```sh
git clone https://github.com/khulnasoft/advanced-istio-service-mesh-workshop
