...
import LinkerdAdapter from "../../../../src/assets/images/learn-khulnasoft/linkerd/linkerd-adapter.webp";
import InstallLinkerd from "../../../../src/assets/images/learn-khulnasoft/linkerd/install-linkerd.webp";

<ChapterStyle>

<h2 class="chapter-sub-heading">Setup Linkerd</h2>

Now that we have a Kubernetes cluster and Meshplay, we are ready to download and deploy Linkerd resources.
...
Using Meshplay, select `Linkerd` from the `Management` menu.
...
You will use Meshplay for collecting and viewing metrics, and Jaeger for viewing distributed traces.
