...
Using Meshplay, select the Linkerd from the Management menu, and:
...
Using Meshplay, click the ➡️ icon on the `Apply Custom Configuration` card and apply the following manifest to your cluster:
