...
The Linkerd sidecar proxy can be either manually or automatically injected into your application's pods. This can be done from the meshplay dashboard for namespace globally by,

1. Using Meshplay, navigate to the Linkerd management page.
...
Using Meshplay, navigate to the Linkerd management page.
