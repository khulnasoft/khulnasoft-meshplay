...
import MeshplayInitialLoadTest from "../../../../src/assets/images/learn-khulnasoft/istio/meshplay_initial_load_test.webp";
import MeshplayCbLoadTest from "../../../../src/assets/images/learn-khulnasoft/istio/meshplay_cb_load_test.webp";
...
Before we can configure circuit breaking, please try to access the `product page` app from within `Meshplay` to ensure all the calls are making it through **without** errors as we did in [Observability chapter](observability) (<a href={MeshplayInitialLoadTest}>see screenshot</a>).
...
This will run the load test and show the results in a chart. (<a href={MeshplayCbLoadTest}> see screenshot </a>).
