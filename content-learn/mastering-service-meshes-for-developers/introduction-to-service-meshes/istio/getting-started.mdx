...
import InstallIstio from "../../../../src/assets/images/learn-khulnasoft/istio/install-istio1.webp";
import IstioDeploy from "../../../../src/assets/images/learn-khulnasoft/istio/install-istio2.webp";

<ChapterStyle>

<h2 class="chapter-sub-heading">Setup Istio </h2>

Now that we have a Kubernetes cluster and Meshplay, we are ready to download and deploy Istio resources.
...
Using Meshplay, select `Istio` from the `Lifecycle` menu.
