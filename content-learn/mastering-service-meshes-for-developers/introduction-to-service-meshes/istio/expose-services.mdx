...
`127.0.0.1. bookinfo.meshplay.khulnasoft.com`
...
- Using Meshplay, navigate to the Custom yaml page, and apply the manifest given below to allow all hosts instead of allowing bookinfo.meshplay.khulnasoft.com only and you are good to access the page using the following url `http://<external-ip of istio-ingressgateway>/productpage`.
...
Using Meshplay, navigate to the Custom yaml page, and apply the below to create the subsets for BookInfo:
