...
const data = {
    ...
    testimonials: [
        {
            quote:
        "Working with Kubernetes and cloud technology, I find one of the most useful tools is Meshplay! I use Meshplay to run POCs for our customers to help them adopt, and then, ongoing to check our mesh configuration. The most fantastic part about Meshplay is it's performance management features.",
