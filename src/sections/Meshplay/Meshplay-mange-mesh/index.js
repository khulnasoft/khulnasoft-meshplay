      ...
      <Container>
        <Row Vcenter>
          <Col sm={12} lg={6}>
            ...
            <Button primary className="banner-btn" title="How Meshplay Works" url="/cloud-native-management/meshplay/operating-cloud-native-infra">
              <GiClockwork size={21} className="button-icon" />
            </Button>
          </Col>
          <Col sm={12} lg={6}>
            <StaticImage src={MultiMesh} alt="Meshplay multi-mesh" className="multi-mesh-img"/>
          </Col>
        </Row>
      </Container>
    </ManageMeshWrapper>
...
export default MeshplayManageMesh;
