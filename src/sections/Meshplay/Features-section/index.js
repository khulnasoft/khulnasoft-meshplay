...
import Slide2 from "../images/meshplay_benchmark_screen.webp";
import Slide3 from "../images/meshplay-configuration-management.webp";
import FeaturesSectionWrapper from "./features-section.style";
import { StaticImage } from "gatsby-plugin-image";

const slide2Path = "../images/meshplay_benchmark_screen.webp";
const slide3Path = "../images/meshplay-configuration-management.webp";
    ...
    <FeaturesSectionWrapper>
      ...
      <div className="section-data">
        ...
        <div className="section-header">
          ...
          {/* <h1>
            <span>Meshplay</span> supports the most service meshes.
          </h1> */}
          <p>
            No matter where you run your workloads, Meshplay just works.
          </p>
        </div>
        <div className="smp-section">
          {/* <h4>No matter what service mesh you use, Meshplay just works.</h4> */}
        ...
        <div className="mesh-mngmnt">
          ...
          <div className="mesh-mngmnt-btn">
            <Col xs={12} sm={6} md={4}>
              <Button secondary className="mgmt_button" title="Install" url="/cloud-native-management/meshplay/getting-started" />
            </Col>
            <Col xs={12} sm={6} md={4}>
              <Button secondary className="mgmt_button" title="Manage" url="/cloud-native-management/meshplay/operating-cloud-native-infra" />
            </Col>
            <Col xs={12} sm={6} md={4}>
