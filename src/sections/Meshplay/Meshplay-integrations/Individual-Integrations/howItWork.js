    ...
    <HowIntegrationWorksWrapper>
      <div className="section-data">
        <div className="section-header">
          ...
          <p>Better together - {name} with <span>Meshplay</span></p>
        </div>
        <div className="integration-section">
          <Row className="integration-section-row">
            <Col xs={12} xl={4} className="integration-section-data">
              <h3>{howitworks != null ? howitworks : "Docker with Meshplay" }</h3>
              <p>
                {howitworksdetails != null ? howitworksdetails : "The Docker Extension for Meshplay extends Docker Desktop’s position as the cloud native developer’s go-to Kubernetes environment with easy access to the next layer of cloud native infrastructure: service meshes."}
              </p>
            </Col>
