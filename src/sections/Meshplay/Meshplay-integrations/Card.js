  ...
  return (
    <IntegrationCard>
      <div className="container">
        ...
        <p>Meshplay is an extensible  platform with many purpose-built extension points. Use Meshplay’s REST API or its GraphQL API both of which allow you to connect to any Kubernetes-native app.</p>
        <Button
          secondary
          title="Learn about Extension Points"
          url="https://docs.meshplay.khulnasoft.com/extensibility"
          external={true}
        />
      </div>
      <div className="container">
