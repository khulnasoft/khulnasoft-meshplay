...
import { LearnKhulnaSoftGridWrapper } from "./learnkhulnasoft.style";
    ...
    <LearnKhulnaSoftGridWrapper>
      ...
      <Container>
        ...
        <JoinCommunity
          ...
          text={"Check Out the KhulnaSoft community, join us on Slack and learn with the community"}
          btn_primary={true} />
      </Container>
    </LearnKhulnaSoftGridWrapper >
  );
