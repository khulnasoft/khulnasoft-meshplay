      ...
      <div className="section">
        <Row className="row">
            ...
            <div className="left">
              <div className="left-child">
                ...
                >
                  ...
                  {/* <img className="KhulnaSoftLogo" src={KhulnaSoftLogo} /> */}
                  <h3 className="statement">
                    {/* Enablers of Engineers. Enablers of Speed. Enablers of Business. */}
                    KhulnaSoft is an empowerer of the developer, the operator, and the service owner
                  </h3>
          ...
          <Col sm={12} md={6} lg={6} className="right-col">
            <StaticImage className="hero" src={imgHero} alt="KhulnaSoft MeshMap screenshot" loading="lazy" />
          </Col>
        </Row>
      </div>
    </BannerSectionWrapper>
