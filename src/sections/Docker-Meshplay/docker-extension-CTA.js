    ...
    <DockerExtensionCTAWrapper>
      <Container>
        <div className="docker-callout">
          <img src={Dockerimage} alt="Docker and Meshplay" loading="lazy" />
          <div className="card-right">
            <div>
              <h2>Docker Extension for Meshplay<br></br> is now available!</h2>
            </div>
            <p>Managing cloud native infrastructure has never been easier.</p>
            <Button primary url="/docker-extension-meshplay" external={false}>
              Use the Meshplay Docker Extension
            </Button>
          </div>
        </div>
      </Container>
