...
const Conduct = () => {
  return (
    <TermsWrapper>
      <PageHeader title="KhulnaSoft Code Of Conduct"
      ...
      <Container>
        <Row>
          <Col xs={12} sm={12} lg={12}>
            ...
            <br />
            <div>
                            Our goal is to maintain a safe, helpful and friendly KhulnaSoft community for everyone, regardless of experience, gender identity and expression, sexual orientation, disability, personal appearance, body size, race, ethnicity, age, religion, nationality, or other protected categories under applicable law.
            </div>
          </Col>
        </Row>
        <Row>
          ...
          <Col xs={12} sm={12} lg={12}>
            ...
            <div>
              ...
              <ul>
                ...
                <li>Visual harassment eg. sexual imagery or use of sexual language at KhulnaSoft community events.</li>
        ...
        <Row>
          <Col xs={12} sm={12} lg={12}>
            ...
            <ul>
              <li>If you are the subject of, or witness to any violations of this Code of Conduct, please contact us by submitting an <a href="https://docs.google.com/forms/d/e/1FAIpQLSeWzC5HjlHugFjB0TtaAVnSkPPqsRQ3JRYjdwyDXf0oyRxcdQ/viewform">incident report</a>, or email community@khulnasoft.com.</li>
            ...
            <p>“@KhulnaSoft Code of Conduct” © 2021 KhulnaSoft, Inc, used under a Creative Commons Attribution Unported license: <a href="http://creativecommons.org/licenses/by/3.0/">http://creativecommons.org/licenses/by/3.0/ </a></p>
          </Col>
        </Row>
      </Container>
    </TermsWrapper>
