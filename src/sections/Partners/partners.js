...
export const partners = [
  {
    ...
    type: "academic",
    imageLink: partner2,
    imageRoute: "https://khulnasoft.com/programs/gsoc",
    ...
    desc: "We have officially partnered with the University of Engineering & Management (UEM), Jaipur. We thank the faculty of UEM Jaipur for partnering with us. As part of the partnership program we have a wide variety of interns from the university participating in our open source projects. The interns have the opportunity to work on a variety of cloud native technologies.Based on the area of their individual interest they can choose the technologies they want to learn or sharpen their skills. Learn more about KhulnaSoft's internships",
    ...
    imageRoute: "https://landscape.cncf.io/?item=provisioning--automation-configuration--meshplay",
    ...
    partnerId: "HashiCorp",
    imageRoute: "https://www.hashicorp.com/partners/tech/khulnasoft",
    ...
    name: "Intel",
    desc: "Intel and KhulnaSoft have partnered to deliver Service Mesh Performance as a new standard of measure for service mesh performance characterization. Collective works have been published by the IEEE and demonstrated at KubeCon.",
    //link: null,
    type: "technology",
    imageLink: <Partner11 alt="Intel" />,
    partnerId: "intel",
    //imageRoute: "https://www.intel.in/content/www/in/en/homepage.html",
    moreInfo: "Intel and KhulnaSoft have partnered to deliver Service Mesh Performance as a new standard of measure for service mesh performance characterization. Collective works have been published by the IEEE and demonstrated at KubeCon.",
  }, {
    name: "VMware",
    desc: "KhulnaSoft enhances the Tanzu Service Mesh experience with Meshplay as an application and infrastructure management platform that accelerates the adoption of open-source and cloud-native technologies by eliminating complexity with its intuitive, efficient, and flexible solution. Using KhulnaSoft's solutions along with Tanzu, engineers can self-service while enterprise IT teams offer Kubernetes as a Service to their application service teams.",
    //link: null,
    type: "technology",
    ...
    moreInfo:
      "KhulnaSoft enhances the Tanzu Service Mesh experience with Meshplay as an application and infrastructure management platform that accelerates the adoption of open-source and cloud-native technologies by eliminating complexity with its intuitive, efficient, and flexible solution. Using KhulnaSoft's solutions along with Tanzu, engineers can self-service while enterprise IT teams offer Kubernetes as a Service to their application service teams.",
  }, {
    ...
    type: "technology",
    partnerId: "docker",
    desc: "KhulnaSoft and Docker have partnered together to bring Kubernetes and cloud native management capabilities to the Docker platform through Meshplay. As part of the partnership, KhulnaSoft has joined the Docker Extension Program, enabling users to easily deploy and manage cloud native infrastructure within their Docker environments. With this collaboration, developers can leverage the power of both Docker and KhulnaSoft's expertise in service mesh technologies to enhance their containerized applications' performance, security, and observability. By integrating Meshplay with Docker, users gain seamless access to advanced features for managing complex microservices architectures effectively.",
    moreInfo: "KhulnaSoft and Docker have partnered together to bring Kubernetes and cloud native management capabilities to the Docker platform through Meshplay. As part of the partnership, KhulnaSoft has joined the Docker Extension Program, enabling users to easily deploy and manage cloud native infrastructure within their Docker environments. With this collaboration, developers can leverage the power of both Docker and KhulnaSoft's expertise in cloud native technologies to enhance their containerized applications' performance, security, and observability. By integrating Meshplay with Docker, users gain seamless access to advanced features for managing complex microservices architectures effectively."
  }
];
