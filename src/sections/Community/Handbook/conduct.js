      ...
      <div className="page-section conduct-section">
        <Container>
          <div className="content">
            <p>KhulnaSoft follows the <a href="https://github.com/cncf/foundation/blob/master/code-of-conduct.md">CNCF Code of Conduct</a> which states that:</p>
            ...
            <p>Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting  <a href="http://community@khulnasoft.com.">community@khulnasoft.com.</a></p>
          </div>
        </Container>
      </div>
      <TocPagination />
