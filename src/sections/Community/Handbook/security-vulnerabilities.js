      ...
      <div className="page-section">
        <Container>
          <div className="content">
            ...
            <p>To make a report, send an email to the private <a href="mailto: security@khulnasoft.com">security@khulnasoft.com</a>  mailing list with the vulnerability details. For normal product bugs unrelated to latent security vulnerabilities, please head to the appropriate repository and submit a <a href="https://github.com/khulnasoft/khulnasoft/issues/new/choose">new issue</a> .</p>
            <p>Note that the KhulnaSoft community spans five GitHub organizations:</p>
            <ul className="project-org-list">
              ...
              <li>
                <a href="https://github.com/khulnasoft">
                  ...
                  - emerging projects and Meshplay extensions, like                 <img
                  src={MeshMap}
                  alt="MeshMap logo"
                  style={{ marginLeft: ".3rem" }}
                />MeshMap.
            ...
            <p>You can find the list of all the KhulnaSoft project repositories <a href="https://khulnasoft.com/community/handbook/repository-overview">here</a></p>
            <h3>When to report a security vulnerability?</h3>
            <p>Send us a report whenever you:</p>
            <ul>
              <li>Think KhulnaSoft projects have a potential security vulnerability.</li>
              <li>Are unsure whether or how a vulnerability affects the project.</li>
              <li>Think a vulnerability is present in another project that KhulnaSoft projects depends on (Docker for example).</li>
            </ul>

            <h3>When not to report a security vulnerability?</h3>
            <p>Don’t send a vulnerability report if:</p>
            <ul>
              <li>You need help tuning KhulnaSoft project components for security.</li>
              <li>You need help applying security related updates.</li>
              <li>Your issue is not security related.</li>
            </ul>
            <p>Instead, join the community <a href="https://slack.khulnasoft.com/">Slack</a>  and ask questions.</p>

            <h3>Evaluation</h3>
            <p>The KhulnaSoft team acknowledges and analyzes each vulnerability report within 10 working days.</p>

            <p>Any vulnerability information you share with the KhulnaSoft team stays within the respective KhulnaSoft project. We don’t disseminate the information to other projects. We only share the information as needed to fix the issue.</p>

            <p>We keep the reporter updated as the status of the security issue is addressed.</p>

            <h3>Fixing the issue</h3>
            <p>Once a security vulnerability has been fully characterized, a fix is developed by the KhulnaSoft team. The development and testing for the fix happens in a private GitHub repository in order to prevent premature disclosure of the vulnerability.</p>

            <h3>Early disclosures</h3>
            <p>The KhulnaSoft project maintains a mailing list for private early disclosure of security vulnerabilities. The list is used to provide actionable information to close KhulnaSoft partners. The list is not intended for individuals to find out about security issues.</p>
            ...
            <ul>
              ...
              <li>KhulnaSoft team ensures all necessary binaries are promptly built and published.</li>
              <li>Once the binaries are available, an announcement is sent out on the following channels:
                <ul>
                  <li>The <a href="https://khulnasoft.com/blog">KhulnaSoft blog</a></li>
                  <li>The <a href="https://twitter.com/khulnasoft">KhulnaSoft Twitter feed</a></li>
                  <li>The <a href="https://khulnasoft.slack.com/archives/CSF3PSZT9">#announcements</a> channel on community <a href="https://slack.khulnasoft.com/">Slack</a></li>
                </ul>
              </li>
            </ul>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>A SQL Injection vulnerability in the REST API in KhulnaSoft Meshplay 0.5.2 allows an attacker to execute arbitrary SQL commands via the /experimental/patternfiles endpoint (order parameter in GetMeshplayPatterns in models/meshplay_pattern_persister.go).</td>
                    <td>REST API</td>
                    <td>v0.5.2</td>
                    <td>v0.5.3</td>
                    <td><a href="https://github.com/khulnasoft/meshplay/pull/2745">fix pull</a></td>
