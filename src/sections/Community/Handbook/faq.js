      ...
      <div className="page-section">
        <Container>
          <div className="content">
            ...
            <p>A: We might not get to everyone, but we try to elevate the works of all of our contributors. All of our community members are proud of their work and so are we! We want their work and names to be recognized across our collective technology industry. Be sure to follow and engage with the <a href="https://twitter.com/khulnasoft">Twitter,</a><a href="https://www.youtube.com/channel/UCFL1af7_wdnhHXL1InzaMvA?sub_confirmation=1"> Youtube,</a> and <a href="https://www.linkedin.com/company/khulnasoft/">Linkedin</a> accounts.</p>

            <h4>Q: I am not a coder, can I contribute too?</h4>
            <p>A: Some community members join to contribute to open source projects, others jump in to put those projects to use, some are here to help cultivate and steward our community, while others are here just to hangout and absorb. All members are most welcome. Be sure to introduce yourself in the KhulnaSoft<a href="https://slack.khulnasoft.com"> slack </a>and let other community members get acquainted with you and vice-versa.</p>
            ...
            <p>A: Yes, outside of the regularly scheduled meetings on the <Link to="https://khulnasoft.com/community/calendar#meetings">community calendar</Link>, there are any number of other meetings that occur to facilitate deeper levels or more concentrated attention to particular bodies of work (e.g. a design spec review). On occasion, these one-off meetings are scheduled in advance and put onto the community calendar, while other times they are simply self-organized by interested contributors. Often contributors will use Slack huddles or Zoom meetings to facilitate the discussion. If you need a new meeting placed onto the community calendar, please reach out to a <Link to="/community/community-managers">Community Manager</Link>.</p>
            ...
            <ol>
              <li>
                ...
                <Link to="https://khulnasoft.com/newcomers"> community member form</Link>. If
              ...
              <li>
                Look for "KhulnaSoft Community" within the Shared Drives section.
              </li>
            </ol>
            <p>
