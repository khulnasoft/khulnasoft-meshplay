      ...
      <Container>
        <Row className="hero">
          <Col sm={12} lg={6}>
            ...
            <p>
                  KhulnaSoft MeshMates are committed to helping community members be successful contributors.
        ...
        <div className="meshmates-grid">
          <h1> Our MeshMates </h1>
          <p> MeshMate is a distinction that KhulnaSoft awards select members of the community that who innately align with the KhulnaSoft culture of helping others, paying it forward, and have a commitment to sharing their knowledge of KhulnaSoft projects with the community. MeshMates are KhulnaSoft ambassadors (not employees) and their commitment to helping others and sharing their expertise has a huge impact on the KhulnaSoft community – don’t hesitate to reach out to them! </p>
          <Row>
        ...
        <div className="expect">
          ...
          <p> The program pairs experienced KhulnaSoft community members with community newcomers to ensure a smooth onboarding experience. There is a lot going in the KhulnaSoft community. Projects and working groups move fast. MeshMates are committed to helping their mentees in identifying an area of the projects to engage within, working groups to join, growing their Cloud Native knowledge, and network of relationships. By connecting one-on-one, MeshMates will share tips on how to have the best community experience possible. </p>
          <p> Meshtees are encouraged to reach out to any MeshMate directly in order to pair up. Introduce yourself either on in the <a href="https://discuss.khulnasoft.com/c/community/12">KhulnaSoft discussion forum</a>. Help your MeshMate understand your current skills, ideal topics of learning, and areas of passion. Doing so will help them to point out various aspects of projects that you might find your first foothold. </p>
        </div>
        <div className="meshmate-meet">
          <Row Vcenter>
            <Col sm={12} lg={6}>
              <h2> Meeting Your MeshMate </h2>
              <p>After pairing up on the <a href="https://discuss.khulnasoft.com/c/community/12">KhulnaSoft discussion forum</a>, the community Slack’s video chat or Google Hangouts are both available for your use as tools for getting to know one another. While getting acquainted and onboarding into the community, we suggest the following goals: </p>
              <table>
                <tr>
                  <td className="icon"><img alt="icon" src={c_icon} /></td>
                  <td className="feature">
                    <h4> Get familiar with all of the projects </h4>
                    <p> Spend time understanding each of the KhulnaSoft initiatives through high level overviews available in the community drive and in discussion with your MeshMate. </p>
                  </td>
                </tr>
                <tr>
                  <td className="icon"><img alt="icon" src={c_icon} /></td>
                ...
                <tr>
                  ...
                  <td className="feature">
                    <h4> Run Meshplay </h4>
                    <p> Put on your user hat and walk-through all of Meshplay’s features and functions as a user. </p>
                  </td>
                </tr>
                <tr>
                  <td className="icon"><img alt="icon" src={c_icon} /></td>
                  <td className="feature">
                    <h4> Build Meshplay </h4>
        ...
        <div className="conduct">
          <h4> Get to know about <Link className="readmore-btn" to="/community/community-managers">KhulnaSoft Community Managers <FiArrowRight /></Link></h4>
        </div>
        <div className="conduct">
