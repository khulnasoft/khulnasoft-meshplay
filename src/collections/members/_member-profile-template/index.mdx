...
khulnasoft: # KhulnaSoft Cloud user ID; last portion of https://meshplay.khulnasoft.com/user/<uuid>
...
meshmate: # [no | yes] Designates whether this member is a KhulnaSoft MeshMate or not.
emeritus: # [no | yes] Designates whether ths member is a KhulnaSoft Meshmate Emeritus or not.
community_manager: # [no | yes] Designates whether this member is a KhulnaSoft Community Manager or not.
