...
description: "Learn about different service meshes, their functionalities, and how Meshplay, an open-source multi-service mesh management plane, facilitates benchmarking and configuration scenarios. "
date: 2021-12-09
...
Talk Link: https://kccncosschn21.sched.com/event/pcYk/cncf-tag-jie-zhang-re-jie-yuan-cncf-tag-network-and-service-mesh-working-group-lee-calcote-khulnasoft-ed-warnicke-cisco-ken-owens-fiserv?iframe=no
published: true
featured: true
upcoming: false
product: Meshplay
...
<h2>
  <a href="https://kccncosschn21.sched.com/event/pcbq/ji-jie-zhi-ke-zha-mu-solving-the-service-mesh-adopters-dilemma-anita-ihuman-khulnasoft?iframe=no">
...
<p>
  This talk introduces Meshplay, an open source, multi-service mesh management
  ...
  deployments. Meshplay facilitates benchmarking various configuration scenarios
  ...
  projects use Meshplay as their performance benchmark tool for each release.
</p>
...
<h2>
  <a href="https://kccncosschn21.sched.com/event/pcYk/cncf-tag-jie-zhang-re-jie-yuan-cncf-tag-network-and-service-mesh-working-group-lee-calcote-khulnasoft-ed-warnicke-cisco-ken-owens-fiserv?iframe=no">
...
<h2>Meshplay Project Office Hours</h2>

<p>Join the Meshplay Project Office Hours at KubeCon China 2021 to learn more about the CNCF's latest service mesh project and its maintainers.</p>
<p>Come and discover why Meshplay is the easiest way to get started with 10+ service meshes!</p>
...
<li>All Meshplay project maintainers</li>
</ul>
...
<p>Learn what Service Mesh Performance is and how Meshplay's implementation uses it to measure the performance of any service mesh available.</p>
...
<h2><a href="https://kccncosschn21.sched.com/event/pcbq/ji-jie-zhi-ke-zha-mu-solving-the-service-mesh-adopters-dilemma-anita-ihuman-khulnasoft?iframe=no">致力于解决服务网格使用中碰到的棘手问题</a></h2>

<p>例如：我们应该如何选择并使用服务网格技术以及如何上手？目前存在哪些不同的服务网格产品，互相之间如何进行对比？了解不同的服务网格产品的功能并且可以直观地对服务网格进行配置。 </p>
<p>本次演讲旨在介绍 Meshplay， 一款开源的多服务网格管理平面，它提供了市面上（至少10个）不同的服务网格产品的生命周期管理，示例应用程序以及开箱即用的服务网格的性能基准测试功能。 Meshplay有能力在各种不同的场景下对任意的服务网格进行性能基准测试的能力，比较不同应用程序在服务网格内外以及不同服务网格之间的性能。它可以根据服务网格的最佳实践来审查网络和服务配置。越来越多的服务网格项目使用Meshplay作为每个版本的性能基准测试工具。 </p>
...
<h2><a href="https://kccncosschn21.sched.com/event/pcYk/cncf-tag-jie-zhang-re-jie-yuan-cncf-tag-network-and-service-mesh-working-group-lee-calcote-khulnasoft-ed-warnicke-cisco-ken-owens-fiserv?iframe=no">CNCF TAG Network and Service Mesh Working Group</a></h2>
...
<p>欢迎大家加入到KubeCon 2021 中国站 Meshplay office hours，来了解CNCF服务网格项目的最新进展，以及与项目维护者进行在线互动。 </p>
<p>快来了解为什么Meshplay是开始使用10+个服务网格的最简单方法！</p>
...
<p>欢迎大家来了解什么是服务网格性能以及Meshplay如何实现衡量任何可用服务网格的性能。 </p>
