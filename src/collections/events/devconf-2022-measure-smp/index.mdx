---
title: "DEVCONF 2022"
description: "Join KhulnaSoft at DevConf.cz 2022 for insightful talks on CNCF projects Meshplay and Service Mesh Performance. Dive into 'Measuring Service Mesh Performance 101' to explore the intricacies of benchmarking service meshes and workload performance."
date: 2022-01-29
...
<p>
  Join KhulnaSoft at <a href="https://www.devconf.info/cz/">DevConf.cz 2022</a> as
  we share on our CNCF projects Meshplay and Service Mesh Performance. Bring
...
<h2>
  ...
  <a href="https://sched.co/siEs">
    {" "}
    Journey Into the World of Service Meshes and Meshplay
  </a>
</h2>
...
Learn how Meshplay, a CNCF Project, multi-service mesh management plane implements the service mesh specifications, Service Mesh Performance (SMP) and Service Mesh Interface (SMI), to empower users to manage more than 10 service meshes simultaneously.

Understand how Meshplay uses a catalog of Cloud Native Patterns to provide templates for best practice configurations and how you can design new patterns with the visual topology designer, MeshMap
