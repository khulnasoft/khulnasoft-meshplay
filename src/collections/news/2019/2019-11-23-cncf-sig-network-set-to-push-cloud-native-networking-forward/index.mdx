...
eurl: ""
dsecription: "Led by Lee Calcote of KhulnaSoft, the SIG aims to amplify the impact of the CNCF Technical Oversight Committee by addressing cross-project networking concerns, encompassing projects like CNI, CoreDNS, Envoy, gRPC, Linkerd, NATS, and Network Service Mesh"
published: true
---
...
Lee Calcote, Founder at KhulnaSoft and one of the leaders of CNCF TAG Network explained during the session that there are already a few network specific projects within the CNCF, including CNI (Container Network Interface), CoreDNS, Envoy, gRPC, Linkerd, NATS and the Network Service Mesh project.
