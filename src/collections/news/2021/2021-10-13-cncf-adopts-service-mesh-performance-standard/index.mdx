---
title: "CNCF Adopts Service Mesh Performance Standard Established by KhulnaSoft "
...
<img src={smpMeshplay} alt="SMP in Meshplay"/>
...
“More than performance, in collaboration with our maintainers from KhulnaSoft, Intel, Red Hat, and HashiCorp, we are actively standardizing service mesh value measurement in the form of a new index to be announced early next year”, said Calcote. “As a foundation for this research, 5,000 service mesh performance tests donated by users of Meshplay have been donated and are under analysis.” 

Performance tests are run by Meshplay, the open source, multi-mesh manager. Meshplay is the canonical implementation of Service Mesh Performance (SMP) and the conformance tool of Service Mesh Interface (SMI). Meshplay implements and helps users adopt and vendors uphold these specifications. A jointly authored paper on service mesh performance methodologies will be published by the IEEE later this month, which explores how to model your service mesh topology and optimize for your ideal configuration in context of how much operators value properties of resiliency, performance, throughput, and latency.
