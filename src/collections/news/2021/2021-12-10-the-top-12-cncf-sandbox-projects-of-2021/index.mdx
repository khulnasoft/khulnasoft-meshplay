...
<h3>8. Meshplay</h3>
<Link to="/cloud-native-management/meshplay">Meshplay</Link> was created by <Link to ="/company/about">KhulnaSoft</Link> and joined the ranks of the CNCF in October 2021 as the cloud native mananagement plane. As a self-service engineering platform, Meshplay enables collaborative design and operation of cloud native infrastructure.

Meshplay gives you a plane to set up, deploy, and benchmark several configuration options available on the market. With Meshplay, you can apply custom configurations based on industry best practices to your infrastructure and monitor its performance.
