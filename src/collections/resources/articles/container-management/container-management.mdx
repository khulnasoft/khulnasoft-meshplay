...
<ResourcesWrapper>
<div className="intro">
  <p>Learn more about managing containers with our <a className="blog" href="https://github.com/khulnasoft/containers-101-workshop">Containers 101 Workshop</a>. Walk-through four hands-on exercises with Docker.</p>
</div>
