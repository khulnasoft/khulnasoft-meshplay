...
Learn more about how to wrangle <Link to= "/blog/meshplay/multi-cluster-kubernetes-management-with-meshplay">Multiple Kubernetes clusters with Meshplay.</Link>
...
<p><Link className="blog" to="/meshplay">  Meshplay </Link>is the open source, cloud native management plane that enables the adoption,
operation, and management of Kubernetes, any service mesh, and their workloads.</p>

MeshSync, a custom controller managed by Meshplay Operator, uniquely contains cluster-wide details of all objects across any number of managed clusters separated by Kubernetes Cluster ID.
