...
<ResourcesWrapper>
  ...
  <div class="fact">
  <p>
    See the KhulnaSoft <Link to="/landscape">service mesh landscape</Link> for a comprehensive perspective of and characterizing of all popular client libraries.
  </p>
  </div>
