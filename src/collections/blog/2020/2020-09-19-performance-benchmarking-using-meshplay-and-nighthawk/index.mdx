---
title: "Performance benchmarking using Meshplay and Nighthawk"
subtitle: ""
...
resource: true
redirect_from:
 - /blog/performance-benchmarking-using-meshplay-and-nighthawk/
---
...
The conclusion can be encapsulated as following, Meshplay, the cloud native management plane possesses the ability to generate load and benchmark services in/out of your service mesh using Fortio, Wrk2 and now, Nighthawk too.

### Meshplay + Nighthawk = Robust Distributed and Scalable Services
...
On the other hand, Meshplay, written and maintainer by KhulnaSoft Community is the multi-service mesh management plane offering lifecycle, configuration and performance management of service meshes and their workloads. With Meshplay, you can both, manage your service mesh's lifecycle, and benchmark them with industry-grade tools to let you know how much under or over-utilized your services are.

<img src={smpImg} alt="smp-image" className="image-left smp-image"/>

Soon, Meshplay is going to be a canonical implementation for [Service Mesh Performance](https://github.com/khulnasoft/service-mesh-performance) which is a common and standardised format to describe : - Performance test configuration - Service mesh configuration - Environment configuration - Workload configuration - Performance test results.

### How did we achieve it ?
The following project was proposed as a Google Summer of Code Idea, I was selected as a student mentee to draft the design, architecture and code my way from scratch. On my journey, I received guidance from some amazing mentors, colleagues and open-source stake holders. I discussed the design proposal with Envoy Team as well as KhulnaSoft Team and from suggestions from both, I was able to complete my project.

In the course of the project, I came up with the idea of invoking Nighthawk as a separate container with which Meshplay will communicate using a go-lang based middleware.

To my elation, the project was a huge success and Nighthawk is now invoked as a load-generator in Meshplay. Soon, the public release for the new version will be made and users will be able to utilize Nighthawk as a performance-benchamark tool alongside with Fortio and Wrk2.
...
- Invoke Nighthawk as an gRPC Service and support gRPC connection between Nighthawk & Meshplay.
