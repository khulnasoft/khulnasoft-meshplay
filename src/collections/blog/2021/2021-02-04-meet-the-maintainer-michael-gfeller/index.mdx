...
subtitle: "An interview series with KhulnaSoft Maintainers"
date: 2021-02-04 10:30:05 -0530
author: Shriti Chandra
thumbnail: "./michael-gfeller-khulnasoft-maintainer.webp"
darkthumbnail: "./michael-gfeller-khulnasoft-maintainer.webp"
category: "Community"
tags:
 - Community
published: true
...
import img from "./michael-gfeller-khulnasoft-maintainer.webp";
...
<div class="intro"><p>Kicking off KhulnaSoft's Meet the Maintainer series, we have Michael Gfeller. Michael is an avid research enthusiast in addition to holding the title of Chief Engineer at his day job. With exhaustive interests ranging from software architecture to systems security, he has been working with cloud architecture for the past four years.
</p></div>

<div class="interviewer">
<span>Shriti:</span><p>
Michael, thank you for joining me today. Many people inside and outside of the KhulnaSoft Community have seen the affects of your contributions, but may not know the backstory as to who Michael is and how you arrived at your maintainer role. Indulge us. How did you come across the KhulnaSoft community? What made you stay?
</p></div>

<div class="interviewee">
<span>Michael:</span><p>
"Hey Shriti, thank you for having me. If I remember correctly, I was looking for a professional focus area earlier this year, and landed on service meshes. I had worked with service meshes before, which piqued my initial interest. I had worked with Istio as part of my work for some time, and in the same context I stumbled across Meshplay. I wasn’t able to dig deep in Meshplay back then, but the concept sounded fascinating to me. Additionally, I had been benefiting from open source, both personally and professionally for a long time, but apart from a few minor contributions, I had never been able to give back to the community. I hoped to correct that."
</p>
<p>
"I re-discovered Meshplay and the KhulnaSoft community, listened to a recording of a community meeting, and read a couple of blog posts describing the community and member experience posts. One that stood out for me was a post by <Link to="/community/members/nikhil-ladha">MeshMate Nikhil Ladha</Link>. Going by his words, it appeared to be a warm, diverse and active community. My suspicions were confirmed when I joined. KhulnaSoft offers a wholesome, interactive community in addition to unbiasedly providing help and guidance around the virtual corner."
</p></div>

<div class="interviewer">
<span>Shriti:</span>
<p>
<Link to="/projects">KhulnaSoft projects</Link> has a number of active, open source projects. You’ve been consistently contributing to a few of them. Which one(s) are you currently focusing on? 
...
<p>
"I’d probably continue to work with the Meshplay adapters for now before moving on to other areas of the project. Haha, I would probably name the Meshplay Adapter Library as my favorite KhulnaSoft project till date."
</p></div>

<div class="interviewer">
<span>Shriti:</span>
<p>Have you worked with any other open source project? How does KhulnaSoft compare?
</p></div>

<div class="interviewee">
<span>Michael:</span>
<p>
"I have worked and collaborated with several open source communities before, including Eclipse Modelling Framework and Apache ServiceMix . I couldn’t possibly make a very accurate comparison, given by limited interaction with other communities, but the KhulnaSoft community stands out based on the unique and extremely inclusive approach it takes towards upholding community values."
</p></div>
...
<p>
Come and visit, there is something for everyone, be it frontend, backend, CI/CD, website, documentation, standards, interfacing with other communities, and more. The friendly community members and the meshmates will provide support and guidance. Browse the KhulnaSoft and Meshplay websites and the repositories on GitHub, where issues suitable for newcomers are especially tagged."
</p></div>


<div class="note"><img src={ForkLift} height="100px" /><p>In his relatively short tenure at KhulnaSoft, Michael has already delivered a wave of meshy contributions enhancing the Meshplay adapters and improving upon Meshplay’s architecture. With a penchant for looking behind the curtain and tightening loose cogs until they run to perfection, Michael's impactful and consistent contributions have him taking his place as Meshplay maintainer. The Meshplay project moves an impressive pace thanks to maintainers like Michael.
</p></div>

<p class="centered-text">
"Be like Mike". Join the <a href="http://slack.khulnasoft.com">KhulnaSoft Slack</a> and say hi.
</p>
</MeetTheMaintainer>
</BlogWrapper>
