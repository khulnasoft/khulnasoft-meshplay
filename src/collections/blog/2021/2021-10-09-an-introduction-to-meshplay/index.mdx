...
thumbnail: ./meshplay-webinar.webp
darkthumbnail: ./meshplay-webinar.webp
category: "Meshplay"
tags:
  - Projects
  - Meshplay
...
import MeshplayClients from "./meshplay-clients.webp";
import Meshplayfeatures from "./meshplay-features.webp";
import MeshplayDeployments from "./meshplay-deployment.webp";
...
<div class="intro ">
  <p>
    Meshplay is the open-source, collaborative cloud native manager that can
...
/>
<p>
  <Link to="/cloud-native-management/meshplay">Meshplay</Link> manages the
  lifecycle of service meshes. Meshplay does workload management, helps you
  onboard or offboard your applications onto the mesh. It also lets you do
  performance management.{" "}
  <a href="https://docs.meshplay.khulnasoft.com/concepts/architecture/meshsync">MeshSync</a>,
  ...
  Through MeshSync, Meshplay supports brownfield deployments of your service meshes
  (Meshplay discovers your existing service mesh deployment that is already running
  inside your cluster(s) whether those service meshes were deployed by Meshplay or
  not){" "}
</p>
<p>
  In order to facilitate such a deep level of understanding of each type of
  service mesh, <Link to="/cloud-native-management/meshplay">Meshplay</Link> has
  ...
  functionality of each service mesh, Meshplay has separate, dedicated adapter
  for each of the{" "}
  <a href="https://docs.meshplay.khulnasoft.com/getting-started/overview#meshplay-is-for-any-service-mesh">
...
<table className="table-1" align="center">
  ...
  <tbody>
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/consul">
    ...
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/istio">
          Meshplay Adapter for Istio
        </a>
      </td>
      <td className="status">stable</td>
    </tr>
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/kuma">
    ...
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/linkerd">
    ...
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/nsm">
    ...
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/osm">
    ...
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/traefik-mesh">
          Meshplay Adapter for Traefik Mesh
        </a>
      </td>
      <td className="status">stable</td>
    </tr>
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/cpx">
    ...
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/nginx-sm">
    ...
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/app-mesh">
          Meshplay Adapter for App Mesh
        </a>
      </td>
    ...
    <tr>
      <td>
        <a href="https://docs.meshplay.khulnasoft.com/service-meshes/adapters/tanzu-sm">
          Meshplay Adapter for Tanzu Service Mesh
        </a>
      </td>
      <td className="status">alpha</td>
    </tr>
...
<p>
  <Link to="/cloud-native-management/meshplay">Meshplay</Link> also lets you
  integrate your Prometheus and Grafana add-ons so you can import your existing
  Grafana dashboards to Meshplay. When you first start Meshplay, we also have a
  configuration wizard, which basically walks you through the entire setup to
  get Meshplay up and running. By the end of this, it will make sure that you
  have Meshplay running on your cluster.
</p>
<img
  src={MeshplayDeployments}
  className="slides-right"
  align="right"
  alt="meshplay-deployment"
/>
<p>
...
<p>
  ...
  <Link to="/cloud-native-management/meshplay">Meshplay</Link> will analyze your
  ...
  directly into Meshplay, edit them in the Meshplay UI itself and actually apply
  these applications or onboard these applications on your service mesh.
</p>

<h3>
  <img
    src={Meshplayoperatoricon}
    align="center"
...
<img
  src={Meshplayfeatures}
  className="slides-left"
  align="right"
  alt="Meshplay-features"
/>
<p>
  <Link to="/cloud-native-management/meshplay/meshplay-operator">
    Meshplay operator
  </Link>{" "}
  is a custom controller called MeshSync. MeshSync helps keep Meshplay apprised
  of the various changes that are going on to the service meshes and various
  changes that are happening within Kubernetes itself. In this way Meshplay
...
<p>
  There's an extensible concept in Meshplay called a{" "}
  <a href="https://docs.meshplay.khulnasoft.com/extensibility/providers">provider</a>.
  ...
  to Meshplay and have a multi-user experience. The other area of extensibility
  is the notion that Meshplay has a couple of APIs both – rest API and graphql
  API. It comes with a command-line interface as well as a user interface.{" "}
</p>

<h3>KhulnaSoft MeshMap</h3>
<p>
  Another capability of Meshplay that is going to be released in the upcoming
...
<p>
  {" "}
  A pattern is capable of describing the deployment of any of the meshes that Meshplay
  ...
  are like a template, they're customizable and ingestible into Meshplay itself.
</p>
<img
...
/>
<p>
  Meshplay will take action based on what you've described in the pattern, things
  ...
  have Meshplay apply it. The patterns are service mesh agnostic, they're
  ...
  apply them to your infrastructure. You can also use Meshplay to visually
...
<p>
  ...
  helps advance the existing integration of nighthawk and Meshplay. Nighthawk is
  ...
  Meshplay to let people recursively evaluate what is ultimately an optimal
...
<h3>
  ...
  <Link to="/cloud-native-management/meshplay">Meshplay</Link> - The Cloud Native
