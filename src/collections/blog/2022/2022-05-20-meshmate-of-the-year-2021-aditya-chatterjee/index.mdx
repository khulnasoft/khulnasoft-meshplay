...
import graduateLFX from "./aditya-chatterjee-graduates-lfx-meshplay-program.webp";
...
<p>
  Nuturing a diverse, inclusive, and newcomer-friendly community like KhulnaSoft's
  is not easy. As a group of hardworking, committed mentors,{" "}
  <Link to="/community/meshmates" className="highlight">
    MeshMates
  </Link>
  , tirelessly work to help make the KhulnaSoft community the award-winning, open
...
<BlockquoteAlt
  className="pull-left"
  quote="Meshmate Aditya is helpful in every kind and the one who should be looked after for the ideal meshmate characteristics. He has promised  Pizzas to each of his friends in KhulnaSoft for this day that has come. Ideal."
...
<p>
  ...
  nearly a hundred people whom Aditya has mentored or supported in the KhulnaSoft
...
<div className="responsive-blog">
  <Blockquote
    quote="Meshmate Aditiya is a very hardworking and very talented individual. His efforts are highly inspirational to all the newcomers in the KhulnaSoft community. He is always ready to help others in the community and always considers others' feedback and suggestions. Many congratulations Aditya for this, and wishing him more in the future :)"
    person="Abhijay Jain"
  />
...
<div style="dispay:flex; flex-wrap:wrap; flex-direction:row; float: right;width:40%;">
  ...
  <p style="color:#666;font-style:italic;">
    Aditya graduates the LFX Meshplay program.
  </p>
</div>
...
/>
  ...
  <Blockquote
    quote="Aditya was a great help when I was finding my feet in KhulnaSoft. He is always ready to help."
...
<div className="responsive-blog">
  <Blockquote
    quote="Aditya’s suggestions on PRs are always helpful. My first PR in the KhulnaSoft project was able to merge because Aditya suggested a CSS trick to improve responsiveness."
    person="Pranav Singh"
  />
...
/>
  ...
  <Blockquote
    quote="Aditya has been a great help to me since the beginning of my journey in KhulnaSoft. His suggestions are always helpful. I really like his willingness to help."
    person="Uzair Shaikh"
  />
...
<div className="responsive-blog">
  <Blockquote
    quote="Aditya has been helpful from the very beginning, I started to contribute to the KhulnaSoft community. His suggestions and tips to solve any issue always worked and it certainly made me amazed at how quickly he would find a solution. I wish him all the best."
...
/>
  ...
  <Blockquote
    quote="Aditya is a great guy, kind, and always ready to help others. He was the one who helped me in starting contributing to KhulnaSoft"
    person="Yash Kamboj"
  />
</div>
...
<Blockquote
  quote="MeshMate Aditya gives of his time willingly and freely, consistently exceeding my expectations with steadfast dedication to his role as a steward of the KhulnaSoft community. More couldn’t be asked of any MeshMate."
  person="Lee Calcote"
/>
