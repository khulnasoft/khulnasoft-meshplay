---
title: "Extending Docker with Meshplay, SPIRE, and Istio"
date: 2022-05-10 10:30:05 -0530
author: Gaurav Chadha
thumbnail: ./dc22-hpe-talk.webp
darkthumbnail: ./dc22-hpe-talk.webp
description: "DockerCon 2022 talk with HPE and Meshplay Docker Extension Demo"
category: "Docker"
tags:
 - Docker
 - Meshplay
...
import meshmapInDocker from './meshmap-docker-extension-for-meshplay.webp';

<BlogWrapper>

<div className="intro">
<p>
    <Link to="/community/members/lee-calcote">Lee Calcote</Link> and <Link to="/community/members/maximiliano-churichi">Maximiliano Churichi</Link> gave a presentation entitled <i>Extending Docker with Meshplay, SPIRE, and Istio</i> at DockerCon 2022.
</p>
</div>
...
<div>
    <h3>
        ...
        <img src={CloudNative} alt="Meshplay Docker Extension" style="width:50%;float:right;" />
    </h3>
    <p>
        Lee Calcote introduces Meshplay as a Cloud Native Management Plane, stating, "Meshplay does Lifecycle and Performance Management of 10 different service meshes more than that it helps with configuration management with Kubernetes and with the Meshplay Docker Extension it does same for the Docker Compose application."
    </p>
</div>                                                                        
                                                                           
<p>
    "As a <Link to="https://www.docker.com/blog/docker-captain-take-5-lee-calcote/">Docker Captain</Link>, Lee have always been a proponent of Docker, and in particular its enablement of developer workflows", "Now, Docker Extensions bring an integrated experience with ecosystem tooling, like Meshplay - a critical tool for developers, who are configuring and managing cloud native applications."
</p>
...
<div>
    ...
    <img src={CloudNativeIdentity} alt="Meshplay Docker Extension" style="width:50%;float:right;" />
    <p>
...
<p>
    <h3>How "Docker Extension for Meshplay" helps to deploy with the click of a button?</h3>
    <p>
    <img src={dde} alt="Meshplay Extension Meshplay" style="width:50%;float:left;padding-right:2rem" />
    The new Meshplay Docker Extension brings <Link to="/meshmap">KhulnaSoft MeshMap</Link>, the world's only visual designer for Kubernetes and service mesh deployments, to the desktop of millions of developers. Developers and operators alike can visually configure and operate their cloud native infrastructure and applications using MeshMap's low code visual designer.
    </p>
</p>    
<p>
    Maximiliano Churichi, Software Engineer at HPE says how conveniently Meshplay integrates different services into Docker.
</p>
<ul>
...
<img src={meshmapInDocker} alt="KhulnaSoft MeshMap in Meshplay Docker Extension" />
...
<div style="  display: grid;
  ...
  <p style="padding-bottom: 1.6rem;">
    ...
    <img src={designer} alt="Meshplay Docker Extension" align="center" alt="MeshMap Designer" />
  ...
  <p>
    ...
    <img src={visualizer} alt="Meshplay Docker Extension" align="center" alt="MeshMap Visualizer" />
  </div>
</div>
...
<p><strong>Lee Calcote and Maximiliano Churichi packed a great deal of information in this talk. Find the recording below. The Meshplay Extension is now out! Try now, and Share your Experience </strong>
