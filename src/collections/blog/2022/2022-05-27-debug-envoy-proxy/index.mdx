...
<p>
  We hope these steps are useful to you. If you're still having trouble configuring Envoy proxy, open up a new thread on the <a href="https://discuss.khulnasoft.com" className="highlight">community discussion forum</a> or subscribe to the <Link to="/subscribe" className="highlight">KhulnaSoft newletter</Link> for tips and tricks.
</p>
