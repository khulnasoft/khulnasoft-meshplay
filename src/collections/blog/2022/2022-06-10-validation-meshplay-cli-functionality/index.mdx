---
title: "Validating Meshplay CLI Functionality"
subtitle: "An introduction to testing meshplayctl"
date: 2022-06-10 10:30:05 -0530
author: Piyush Singariya
description: Guide for End to End manual testing Meshplay CLI (meshplayctl)
...
<p>So put on your <strong>Quality Tester</strong> hats because here I&#39;ll talk about how to test the PRs with the label <code>component/meshplayctl</code> i.e. pull-requests related to <code>meshplayctl</code></p>
...
<pre><code class="language-bash">gh pr checkout https://github.com/meshplay/meshplay/pull/4823
</code></pre>
</li>
...
<li><p>Well, if we&#39;re testing a PR related to meshplayctl, we need to build the binary from the same branch. change your directory to <code>meshplayctl</code> folder and run</p>
<pre><code class="language-bash">make
</code></pre>
<p>This will create a meshplayctl binary according to your OS in the same directory</p>
</li>
...
<pre><code class="language-bash">./meshplayctl system start 
</code></pre>
