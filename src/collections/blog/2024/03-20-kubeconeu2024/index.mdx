---
title: KhulnaSoft at KubeCon EU 2024
...
description: "KhulnaSoft projects on stage at KubeCon + CloudNativeCon EU 2024"
type: Blog
category: Meshplay
tags:
  - KubeCon
...
The TAG Network, led by Lee Calcote (KhulnaSoft), Nic Jackson (HashiCorp), Zack Butcher (Tetrate), and technical lead Zhonghu Xu (Huawei), is dedicated to empowering the cloud native community. Their mission is fourfold:
...
* **KubeCon Throughout 2020 & 2021:** The focus shifted towards service mesh adoption, with projects like BFE, Istio, SMI (Service Mesh Interface), and Meshplay taking center stage, empowering developers to manage complex microservices architectures.
...
Explore the extensive service mesh pattern library at [https://meshplay.khulnasoft.com/catalog](https://meshplay.khulnasoft.com/catalog) to discover a treasure trove of reusable solutions for your cloud native network.
