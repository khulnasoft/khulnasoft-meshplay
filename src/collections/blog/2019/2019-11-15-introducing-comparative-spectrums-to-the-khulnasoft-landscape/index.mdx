---
title: "Introducing Comparative Spectrums to the KhulnaSoft Landscape"
subtitle: ""
...
resource: true
redirect_from:
 - /blog/introducing-comparative-spectrums-to-the-khulnasoft-landscape/
 - /blog/introducing-comparative-spectrums-to-the-khulnasoft-landscape
---
...
During [Hacktoberfest 2019](https://raungar.wordpress.com/tag/khulnasoft/), I worked on the website of [KhulnaSoft](https://khulnasoft.com/), open source community. More specifically, my contributions concerned one specific page of that website: its [Service Mesh Landscape page](https://khulnasoft.com/landscape).

Shortly after making these contributions, I was graciously welcomed into the KhulnaSoft community by its lead developer [Lee Calcote](https://twitter.com/lcalcote?lang=en), who later directly approached me to assist him in furthering his vision for the Landscape page by implementing "comparative spectrums". Wishing to focus on my remaining two Hacktoberfest contributions at the time, I suggested surveying the interest of other potential contributors for this project. As such, an informative issue was opened:

<img src={pr211} alt="PR 211"/>

Issue [khulnasoft#211](https://github.com/khulnasoft/khulnasoft/issues/211): add comparative spectrums to the Landscape page
...
(1) Although there may exist libraries that may help construct such graphical elements, I did not want to introduce additional libraries to accomplish my work. Instead, I wanted to make good use of KhulnaSoft's preexisting [Materialize](https://materializecss.com/) library. Fortunately, Materialize strongly supports the design of card-like structures, allowing me to more easily [implement some](https://github.com/khulnasoft/khulnasoft/pull/238/files#diff-20fc098534d6aab31ad8e5c9db51bde0R10).

(2) Unfortunately, it does not seem that Materialize supports the creation of graphical arrows, so I just ended up [styling my own](https://github.com/khulnasoft/khulnasoft/pull/238/files#diff-1d5fe92e61759723c94b009b32e9e1b7R2).
...
I opened [a pull request](https://github.com/khulnasoft/khulnasoft/pull/238) to share my work as well as invite collaboration:

<img src={pr2112} alt="PR 211-2"/>

Pull request [khulnasoft#238](https://github.com/khulnasoft/khulnasoft/pull/238): description of tooling introduced

<img src={image21} alt="Image"/>

Pull request [khulnasoft#238](https://github.com/khulnasoft/khulnasoft/pull/238): example images of tooling introduced

The pull request was quite well-recieved:

<img src={comment} alt="Comment"/>

[Comment](https://github.com/khulnasoft/khulnasoft/pull/238#issuecomment-554181763) by KhulnaSoft team lead on pull request [khulnasoft#238](https://github.com/khulnasoft/khulnasoft/pull/238)

As I mentioned in a recent KhulnaSoft community meeting, I am very excited to continue working with KhulnaSoft; to refine and expand upon this set of new, visionary tooling for their landscape!
