---
title: "KhulnaSoft: Landscape Spectrums Revisited"
subtitle: ""
...
resource: true
redirect_from:
 - /blog/khulnasoft-landscape-spectrums-revisited/
---
...
Several weeks ago, I wrote [a blog post](https://raungar.wordpress.com/2019/11/15/introducing-comparative-spectrums-to-the-khulnasoft-landscape/) about introducing "comparative spectrum" tools to [the KhulnaSoft landscape](https://khulnasoft.com/landscape)—a webpage which I have transformed multiple times, now!

Up until now, the contents of each blog post I have written were centered upon a freshly-opened pull request. Shortly before writing my last post, I did open [one such pull request (khulnasoft#238)](https://github.com/khulnasoft/khulnasoft/pull/238). However, since my PR remains open, and since I am still working on the same issue my PR addresses, I have opted to instead push [a new commit](https://github.com/khulnasoft/khulnasoft/pull/238/commits/4d396aaa6d3ca46add71531daedc8c0e2a5d2495) to the aformentioned (but, now, renamed) PR instead of creating a whole new one. This newest commit introduces a major step towards resolving the issue at hand, and will be the subject of this blog post!

<img src={issueImage} alt="Issue"/>

The issue at hand: [khulnasoft#211](https://github.com/khulnasoft/khulnasoft/issues/211) - add comparative spectrums to the Landscape page

* * *

_**Note:** this blog post will frequently reference [the update and documentation comment that I made](https://github.com/khulnasoft/khulnasoft/pull/238#issuecomment-561613644) to accompany my last commit to my PR. I consider this hefty comment to be an extension of this blog post, so I strongly recommend giving it a read!_
...
As documented in my [update comment](https://github.com/khulnasoft/khulnasoft/pull/238#issuecomment-561613644), I designed a table that very closely resembles that of Lee's slides. Implementing the table was interesting, as it ended up requiring [quite a few nested Liquid for-loops](https://github.com/khulnasoft/khulnasoft/blob/4d396aaa6d3ca46add71531daedc8c0e2a5d2495/_includes/partials/spectrum/table.html#L23). Also as documented, I revamped the grid-based tooling and am quite pleased with the improvements made. The end result of these efforts is a complete set of comparative spectrums.

#### 2, 3. A modular design and documentation

The bulk of the documentation I wrote details how to deal with the modular solution that I designed and implemented to enable comparative spectrums to be included into the Landscape page (through the use of Liquid `include` tags). The documentation speaks for itself; [check it out!](https://github.com/khulnasoft/khulnasoft/pull/238#issuecomment-561613644)

## What's next?

I would not have considered the documentation I delivered to be complete if I did not report on the issues still present in the work I delivered. I denoted these as 'Current issues' in the documentation, and they represent work that still remains to be done. I know that I can count on the KhulnaSoft community to assist me with small issues like these, and, once this pull request receives some forward motion, I hope to start zeroing in on its smaller issues. Fortunately, I have made plans to continue working with open source well into the new year!
