...
<h2>Participate in Hacktoberfest 2022 with KhulnaSoft</h2>
<p>
...
<h4><strong>KhulnaSoft celebrates and supports all open source contributors in our global community.</strong></h4>
<p>
    KhulnaSoft is a warm and welcoming community of open source contributors. We
...
<p>
    Our cloud native application and infrastructure management software enables organizations to expect more from their infrastructure. The KhulnaSoft community represents the largest collection of service mesh projects and their maintainers in the world. We build projects to provide learning environments, deployment and operational best practices, performance benchmarks, create documentation, share networking opportunities, and more. Our shared commitment to the open source spirit pushes KhulnaSoft projects forward. 
</p>

<h4><strong>Hacking on open source issues</strong></h4>

<p>
    We have communities spread across the month of October to introduce you to the <Link to="/community/handbook/repository-overview" class="highlight">KhulnaSoft project repositories</Link> and help you get started on those pull requests.
</p>
<p>
      A long list of
      <a
        href="https://github.com/issues?q=is%3Aopen+is%3Aissue+archived%3Afalse+org%3Ameshplay+org%3Aservice-mesh-performance+org%3Akhulnasoft+org%3Aservice-mesh-patterns+org%3Akhulnasoft+label%3Ahacktoberfest" target="_blank" class="highlight"> hacktoberfest </a> issues
      have been specially curated in anticipation of our hackers! Here is a list of
      <a href="https://github.com/issues?q=is%3Aopen+is%3Aissue+archived%3Afalse+org%3Ameshplay+org%3Aservice-mesh-performance+org%3Akhulnasoft+org%3Aservice-mesh-patterns+org%3Akhulnasoft+label%3A%22help+wanted%22+" target="_blank" class="highlight"> help wanted </a> issues
...
<table class="tutorials-table" style="margin:0px; padding:0px; width:100%; text-align: left;">
  ...
  <tbody>
    <tr>
      <td>Oct. 1st, 2020</td>
      <td><i>An Introduction to Contributing to Meshplay</i></td>
      <td>
    ...
    <tr>
      <td>Oct. 8th, 2020</td>
      <td><i>An Introduction to meshplayctl</i></td>
      <td><a
    ...
    <tr>
      <td>Oct. 15th, 2020</td>
      <td><i>A tutorial on contributing to KhulnaSoft and working with Git </i></td>
      <td><a
    ...
    <tr>
      <td>Oct. 22nd, 2020</td>
      <td><i>An introduction to all KhulnaSoft repositories</i></td>
      <td><a
    ...
    <tr>
     ...
     <tr>
      <td>Nov. 4th, 2020</td>
      <td><i>Functional Testing with Cypress in Meshplay UI</i></td>
      <td><a
          href="https://khulnasoft.com/blog/meshplay/functional-testing-with-cypress-in-meshplay-ui" target="_blank">slides</a>, <a
     ...
     <tr>
      <td>Jan. 28th, 2021</td>
      <td><i>Beginner's guide to contributing to Meshplay and meshplayctl</i></td>
      <td><a
      ...
      <td>KhulnaSoft Contributor</td>
    </tr>
     <tr>
      <td>Jul. 27th, 2021</td>
      <td><i>Contributing to Meshplay API Swagger Documentation</i></td>
      <td><a
...
<div>
    Interested? Checkout the <a href="/community">KhulnaSoft community</a> and join us on <a href="http://slack.khulnasoft.com" target="_blank">Slack</a>
</div><br/>
